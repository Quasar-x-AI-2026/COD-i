/*
  ...
  - You are about to alter the column `endTime` on the `ClassSession` table. The data in that column could be lost. The data in that column will be cast from `String` to `DateTime`.
  - You are about to alter the column `startTime` on the `ClassSession` table. The data in that column could be lost. The data in that column will be cast from `String` to `DateTime`.
...
CREATE UNIQUE INDEX "ClassSession_subjectId_teacherId_sessionDate_startTime_key" ON "ClassSession"("subjectId", "teacherId", "sessionDate", "startTime");

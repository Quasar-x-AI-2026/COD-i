...
export type EnrollmentOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"studentId" | "subjectId", ExtArgs["result"]["enrollment"]>
...
export interface EnrollmentDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * })
   * 
   * // Create many Enrollments and only return the `studentId`
   * const enrollmentWithStudentIdOnly = await prisma.enrollment.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more Enrollments and only return the `studentId`
   * const enrollmentWithStudentIdOnly = await prisma.enrollment.updateManyAndReturn({
   *   select: { studentId: true },
   *   where: {
   *     // ... provide filter here
   *   },
